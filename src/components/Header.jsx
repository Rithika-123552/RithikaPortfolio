            ...
            >
              <div className="p-4">
                {products.map((item) => (
                  ...
                  >
                    <div className="flex size-11 flex-fane items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                      <item.icon
                        aria-hidden="true"
              ...
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  <DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pr-3.5 pl-3 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">
                    ...
                    <ChevronDownIcon
                      aria-hidden="true"
                      className="size-5 flex-fane group-data-open:rotate-180"
                    />
                  </DisclosureButton>
